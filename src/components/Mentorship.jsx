 ...
 * Defines system constants, data thresholds, and the master design token palette.
 */
const CONFIG = {
  SYSTEM: {
...
const Button = ({ children, onClick, variant = 'primary', active = false, fullWidth = false, disabled = false, style = {}, icon }) => {
  let baseStyle = {
